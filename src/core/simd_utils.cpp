...
void subtract_vectors(const float* a, const float* b, float* result, int count) { scalar::subtract_vectors(a, b, result, count); }
...
void scale_vectors(float scale, const float* a, float* result, int count) { scalar::scale_vectors(scale, a, result, count); }
void scale_add_vectors(float scale, const float* a, const float* b, float* result, int count) { scalar::scale_add_vectors(scale, a, b, result, count); }
void clamp_vectors(const float* a, float lo, float hi, float* result, int count) { scalar::clamp_vectors(a, lo, hi, result, count); }
int sanitize_nonfinite(const float* a, float fallback, float* result, int count) { return scalar::sanitize_nonfinite(a, fallback, result, count); }
float reduce_sum(const float* a, int count) { return scalar::reduce_sum(a, count); }
void reduce_min_max(const float* a, int count, float* out_min, float* out_max) { scalar::reduce_min_max(a, count, out_min, out_max); }
